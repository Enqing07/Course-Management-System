/**
 * The Student class represents a student user, extending the User class.
...
public class Student extends User {
  ...
  /**
   * Create a student with the specified id, name, password, current trimester, current triemster credit and total credits.
   * 
